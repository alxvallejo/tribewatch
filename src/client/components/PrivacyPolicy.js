	...
	return (
		<Container>
			...
			<p>
				...
				<a href="https://tribewatch.us">https://tribewatch.us</a> (hereinafter, "us", "we", or
				"https://tribewatch.us"). We respect your privacy and are committed to protecting personally
				...
				Policy applies only to information we collect through the Website and does not apply to our collection
			...
			<p>
				...
				referring site, and the date and time of each visitor request. Tribewatch's purpose in collecting
				non-personally identifying information is to better understand how Tribewatch's visitors use its
				website. From time to time, Tribewatch may release non-personally-identifying information in the
				aggregate, e.g., by publishing a report on trends in the usage of its website.
			</p>
			<p>
				Tribewatch also collects potentially personally-identifying information like Internet Protocol (IP)
				addresses for logged in users and for users leaving comments on https://tribewatch.us blog posts.
			...
			<p>
				...
				visitor's browser provides to the website each time the visitor returns. Tribewatch uses cookies to help
				Tribewatch identify and track visitors, their usage of https://tribewatch.us, and their website access
				preferences. Tribewatch visitors who do not wish to have cookies placed on their computers should set
				their browsers to refuse cookies before using Tribewatch's websites, with the drawback that certain
				features of Tribewatch's websites may not function properly without the aid of cookies.
			</p>
			<p>
			...
			<p>
				...
				<a
					...
					href="https://privacytermsgenerator.com/privacypolicy/"
				...
				<a href="mailto:alxvallejo@gmail.com">email</a> or <a href="tel:9782704786">phone</a>.
			</p>
		</Container>
	);
};
